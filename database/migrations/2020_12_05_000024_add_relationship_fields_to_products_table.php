...
class AddRelationshipFieldsToProductsTable extends Migration
{
    public function up()
    {
        ...
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->foreign('main_product_type_id')->references('id')->on('main_product_types');

            $table->unsignedBigInteger('sub_product_type_id')->nullable();
            $table->foreign('sub_product_type_id')->references('id')->on('sub_product_types');

            $table->unsignedBigInteger('sub_product_service_type_id')->nullable();
            $table->foreign('sub_product_service_type_id')->references('id')->on('sub_product_service_types');

            $table->unsignedBigInteger('main_product_service_type_id')->nullable();
            $table->foreign('main_product_service_type_id')->references('id')->on('main_product_service_types');
