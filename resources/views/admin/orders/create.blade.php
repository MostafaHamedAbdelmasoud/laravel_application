        ...
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_variant') ? 'is-invalid' : '' }}" name="product_variant[]" id="product_variant" multiple required>
                    ...
                    <option value="{{ $product_variant->id }}" {{ in_array($product_variant->id , old('product_variant', [])) ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal') ? 'is-invalid' : '' }}" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }}" type="number" name="details" id="details"  required>{{ old('details', '') }}</textarea>
