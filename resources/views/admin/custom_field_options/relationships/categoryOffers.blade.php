...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-custom_field_optionOffers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.offer.fields.custom_field_option') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($offers as $key => $offer)
                        <tr data-entry-id="{{ $offer->id }}">
                            ...
                            <td>
                                {{ $offer->custom_field_option->name ?? '' }}
                            </td>
                            <td>
                                {{ $offer->add_date ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-custom_field_optionOffers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
