...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-custom_field_optionDepartments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.department.fields.custom_field_option') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($departments as $key => $department)
                        <tr data-entry-id="{{ $department->id }}">
                            ...
                            <td>
                                {{ $department->custom_field_option->name ?? '' }}
                            </td>
                            <td>
                                @can('department_show')
...
@endcan
  ...
  let table = $('.datatable-custom_field_optionDepartments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
